...
class CAdamoDGComm : public CTreeView
{
protected:
	CAdamoDGComm();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CAdamoDGComm)
