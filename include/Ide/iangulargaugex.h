#if !defined(AFX_IANGULARGAUGEX_H__B834B68B_C719_47CA_B6E9_0A0F703B4C1B__INCLUDED_)
#define AFX_IANGULARGAUGEX_H__B834B68B_C719_47CA_B6E9_0A0F703B4C1B__INCLUDED_
...
public:
	...
	BOOL GetHub3D();
	void SetHub3D(BOOL bNewValue);
	BOOL GetShowFace();
	void SetShowFace(BOOL bNewValue);
	unsigned long GetFaceColor();
	void SetFaceColor(unsigned long newValue);
	long GetFaceBevelSize();
	void SetFaceBevelSize(long nNewValue);
	long GetFaceStyle();
	void SetFaceStyle(long nNewValue);
	long GetFaceBevelStyle();
	void SetFaceBevelStyle(long nNewValue);
...
#endif // !defined(AFX_IANGULARGAUGEX_H__B834B68B_C719_47CA_B6E9_0A0F703B4C1B__INCLUDED_)
