...
public:
    ...
    // called whenever we need to paint a column
    virtual void OnPaintColumn (LPDRAWITEMSTRUCT lpDrawItemStruct, int nColumn, CRect* rc); 
    virtual int  OnDrawPlusMinus(CDC* pDC, CTreeItem* pSelItem, int nListItem, const CRect& rcBounds);
public:
	//creates a root
    ...
    void SetGraphicalColumn (int nEl, int nIsGraphic);
...
class CSuperGridCtrl::CTreeItem : public CObject
{
    ...
    public :
        CItemInfo* GetNodeInfo ()   { return m_lpNodeInfo; }
};
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
//{{AFX_INSERT_LOCATION}}
