...
public:
    ...
    virtual void    DrawTabNumber ( CDC* dc, double zoom );
    ...
    virtual bool    IsTabbeble ();
    virtual bool    SelectTab (int nTabIndex, int* nPrevTabIndex);
    virtual bool    AdjustTabOrder (int nTabIndex, int nPrevTabIndex, bool b);
    ...
    void            Assign (bool bAssign)       { m_bAssigned=bAssign; }
...
protected:
	...
	virtual void	DrawTab( CDC* dc, CRect rect ) const;
