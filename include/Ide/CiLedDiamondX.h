// CiLedDiamondX.h  : dichiarazione di classi wrapper di controlli ActiveX create da Microsoft Visual C++
...
class CiLedDiamondX : public CWnd
{
protected:
	DECLARE_DYNCREATE(CiLedDiamondX)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0x7314B3A4, 0xD28B, 0x11D3, { 0x85, 0xC2, 0x0, 0xA0, 0xCC, 0x3A, 0x58, 0xC9 } };
		return clsid;
	}
