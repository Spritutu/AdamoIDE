...
#import "C:\Program Files (x86)\Common Files\System\ado\MSJRO.DLL" rename("ReplicaTypeEnum", "_ReplicaTypeEnum")
#import "C:\Program Files (x86)\Common Files\System\ado\MSADOX.DLL"  rename ("DataTypeEnum", "DataTypeEnumX") no_namespace
using namespace JRO;
#else
#import "C:\Programmi\File Comuni\System\ADO\msado15.dll" rename("EOF", "EndOfFile")
#import "C:\Programmi\File Comuni\System\ADO\MSJRO.DLL" no_namespace
#import "C:\Programmi\File Comuni\System\ADO\MSADOX.DLL" rename ("DataTypeEnum", "DataTypeEnumX") no_namespace
using namespace ADODB;
#endif
