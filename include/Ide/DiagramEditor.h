...
#define ARRANGE_BUTTON_OFFSET 4
...
protected:
    ...
    virtual void DrawTabNumber( CDC* dc, double zoom ) const;
...
public:
    ...
    virtual void ShowTab (BOOL TabMode);
	...
	virtual void	MakeSameSizeSelectedHorizontal();
	virtual void	MakeSameSizeSelectedVertical();
	virtual void	MakeSameHorizontalPlane();
	virtual void	MakeSameVerticalPlane();
	virtual void	CenterInDiagramHorizontal();
	virtual void	CenterInDiagramVertical();
	virtual void	DisposeButtonBottom();
	virtual void	DisposeButtonRight();
...
protected:
	...
	virtual afx_msg void OnParentNotify(UINT message, LPARAM lParam);
...
private:
    ...
    void        GestioneTab (CPoint point);
    void        TabOrder (CDiagramEntity* obj, int nTabIndex, int nPrevTabIndex, bool b);
    void        CorrectTabIndex ();
