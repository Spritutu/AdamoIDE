   ...
   ============================================================*/
{
	...
	if( m_menu.m_hMenu == NULL )
	{
		if( m_menu.CreatePopupMenu() )
		{
			...
			m_menu.AppendMenu( MF_STRING, ID_EDIT_CUT, LOADSTRING (IDS_ADAMODIAGRAMMENU_1) );
			m_menu.AppendMenu( MF_STRING, ID_EDIT_COPY, LOADSTRING (IDS_ADAMODIAGRAMMENU_2) );
			m_menu.AppendMenu( MF_STRING, ID_EDIT_PASTE, LOADSTRING (IDS_ADAMODIAGRAMMENU_3) );

			m_menu.AppendMenu( MF_SEPARATOR );

			m_menu.AppendMenu( MF_STRING, ID_EDIT_GROUP, LOADSTRING (IDS_ADAMODIAGRAMMENU_4) );
			m_menu.AppendMenu( MF_STRING, ID_EDIT_UNGROUP, LOADSTRING (IDS_ADAMODIAGRAMMENU_5) );
		}
	}
