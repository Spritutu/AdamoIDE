...
void CProjectProperties::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_SYNTAX_CHECKING,  m_bSyntaxChecking);
	...
	DDX_Check(pDX, IDC_PROPAGATE_MESSAGES, m_bPropagateMessages);
	//}}AFX_DATA_MAP
}
...
BEGIN_MESSAGE_MAP(CProjectProperties, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(ID_LIBRARIES, &CProjectProperties::OnBnClickedLibraries)
END_MESSAGE_MAP()
...
void CProjectProperties::OnBnClickedLibraries()
{
	// TODO: aggiungere qui il codice per la gestione della notifica del controllo.
	CDlgInstallLibraries dlgInstallLibraries;
	if (dlgInstallLibraries.DoModal () == IDOK)   {
		m_listLibraries.RemoveAll ();
		CStringList& list = dlgInstallLibraries.GetListLibraries ();
