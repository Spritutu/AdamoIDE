...
double CiLedBarX::GetFillReferenceValue()
{
	double result;
...
void CiLedBarX::SetFillReferenceValue(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
BOOL CiLedBarX::GetFillReferenceEnabled()
{
	BOOL result;
...
void CiLedBarX::SetFillReferenceEnabled(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
VARIANT CiLedBarX::GetOPCItemDataNow(long Index, short* Quality)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I4 VTS_PI2;
...
BOOL CiLedBarX::GetOPCItemUpdateSuspended(long Index)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4;
...
double CiLedBarX::GetOPCItemScalar(long Index)
{
	double result;
	static BYTE parms[] =
		VTS_I4;
...
double CiLedBarX::GetOPCItemOffset(long Index)
{
	double result;
	static BYTE parms[] =
		VTS_I4;
...
void CiLedBarX::SetOPCItemScalar(long Index, double Value)
{
	static BYTE parms[] =
		VTS_I4 VTS_R8;
...
void CiLedBarX::SetOPCItemOffset(long Index, double Value)
{
	static BYTE parms[] =
		VTS_I4 VTS_R8;
...
unsigned long CiLedBarX::GetSectionColor4()
{
	unsigned long result;
...
void CiLedBarX::SetSectionColor4(unsigned long newValue)
{
	static BYTE parms[] =
		VTS_I4;
...
unsigned long CiLedBarX::GetSectionColor5()
{
	unsigned long result;
...
void CiLedBarX::SetSectionColor5(unsigned long newValue)
{
	static BYTE parms[] =
		VTS_I4;
...
double CiLedBarX::GetSectionEnd3()
{
	double result;
...
void CiLedBarX::SetSectionEnd3(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CiLedBarX::GetSectionEnd4()
{
	double result;
...
void CiLedBarX::SetSectionEnd4(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
