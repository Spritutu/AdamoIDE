...
IMPLEMENT_DYNAMIC(CAdamoSynListBox, CListBox)

CAdamoSynListBox::CAdamoSynListBox() : m_pParent (NULL), m_pFont (NULL), m_nOptions (0)
{

}

CAdamoSynListBox::~CAdamoSynListBox()
{
}


BEGIN_MESSAGE_MAP(CAdamoSynListBox, CListBox)
END_MESSAGE_MAP()

/*
** Create :
*/
BOOL CAdamoSynListBox::Create ()
{
	BOOL b = CListBox::Create (WS_CHILD | WS_VISIBLE | LBS_STANDARD, GetObjStyle ().GetRect (), m_pParent, GetID ());
	FillOptions ();
	if (b)
		CreateFont ();
	return TRUE;
...
** CreateFont :
*/
void CAdamoSynListBox::CreateFont ()
{
...
** OnDownload :
*/
int CAdamoSynListBox::OnDownload ()
{
...
** AddRSOption :
*/
void CAdamoSynListBox::AddRSOption (stRSOpzioni* pOpt, int nPos)
{
...
** GetRSOptions :
*/
void CAdamoSynListBox::GetRSOptions (stRSOpzioni* pOptions, int* nOptions)
{
...
** FillOptions :
*/
void CAdamoSynListBox::FillOptions ()
{
	for (int i = 0; i < m_nOptions; i++)   {
