...
void CColorStaticST::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	// TODO: Add your message handler code here and/or call default
	m_pParent->PostMessage(WM_OPENDIALOGBARS, GetDlgCtrlID(), 0);
	CXTCaption::OnLButtonDblClk(nFlags, point);
}
