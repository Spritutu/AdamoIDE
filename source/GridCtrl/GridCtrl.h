...
// This is sent to the Grid from child in-place edit controls
typedef struct tagGV_CHECKNOTIFY {
    NMHDR      hdr;
    int        iCheck;
} GV_CHECKNOTIFY;
...
#define GVN_BUTTONCHECKED       TB_CHECKBUTTON
#define GVN_BUTTONPRESSED       TB_PRESSBUTTON
...
#endif
    void ShowAlwaysTitleTips (BOOL b=TRUE)   { m_TitleTip.ShowAlways (b); }
///////////////////////////////////////////////////////////////////////////////////
// Cell Ranges
///////////////////////////////////////////////////////////////////////////////////
 public:
